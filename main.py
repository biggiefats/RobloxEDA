...
in their title will have a greater ratio
of current players to total players than games
that do not.

There is a quadratic proportion between one
of two variables in this dataset.
